...
```
occam-run -nnodeXX ofriard/acoustic 3rd_octave -d my_sounds_archive -c 6 -o my_results.tsv
```

In case of silenced WAV files (0.5 s of silence at the beginning and 0.5 s at the end):

```
occam-run -nnodeXX ofriard/acoustic 3rd_octave -d my_sounds_archive -c 6 -i 0.5 -f 0.5 -o out.tsv
```
or

```
occam-run -nnodeXX ofriard/acoustic 3rd_octave --directory my_sounds_archive --cpu 6 --initial-silence 0.5 --final-silence 0.5 -o out.tsv
```
